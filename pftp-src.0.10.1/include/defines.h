...
#define	PFTP_EDITION		"WiNDOWS"

#ifdef TLS
#define	PFTP_VERSION		"v-ID$: II@0.10.1@TLS"
#else
#define	PFTP_VERSION		"v-ID$: II@0.10.1"
#endif

#define PATHLEN 4096

#define	BOOKMARK_ID		"II@0.10.0\n"
