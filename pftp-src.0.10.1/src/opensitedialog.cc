...
void CDisplayHandler::UpdatePrefsItems(void)
{
    ...
    mvwaddstr(this->window_prefs, 19, 2,
              "filelist sorting method: ");
    ...
    for (n = 0; n < 27; n++) {
        ...
        case 5:
    	    mvwaddstr(this->window_prefs, 7, 2, "[ ] SSL Auth");
            if (this->use_ssl)
        ...
        case 6:
            mvwaddstr(this->window_prefs, 7, 23, "[ ] SSL DirList");
        ...
        case 7:
            mvwaddstr(this->window_prefs, 7, 47, "[ ] SSL Data");
            if (this->use_ssl_data)
                mvwaddch(this->window_prefs, 7, 48, 'x');
            wattrset(this->window_prefs, attr);
            break;

        case 8:
            mvwaddstr(this->window_prefs, 8, 2, "[ ] use passive mode for data transfers and dirlisting");
            if (this->use_pasv)
        ...
        case 9:
            mvwaddstr(this->window_prefs, 9, 2, "[ ] after login cwd to");
            if (this->use_startdir)
                mvwaddch(this->window_prefs, 9, 3, 'x');
            wattrset(this->window_prefs, attr);
            mvwaddnstr(this->window_prefs, 9, 25, filler, 34);
            mvwaddnstr(this->window_prefs, 9, 25, this->startdir, 34);
            break;
        ...
        case 10:
            ...
            wattrset(this->window_prefs, attr);
            mvwaddnstr(this->window_prefs, 10, 37, filler, 22);
            mvwaddnstr(this->window_prefs, 10, 37, this->exclude, 22);
            break;
        ...
        case 12:
            ...
            wattrset(this->window_prefs, attr);
            mvwaddnstr(this->window_prefs, 12, 29, filler, 3);
            sprintf(this->temp_string, "%d", this->noop_rate);
            mvwaddnstr(this->window_prefs, 12, 29, this->temp_string, 3);
            break;
        ...
        case 19:
            mvwaddstr(this->window_prefs, 19, 27,
                      "[ ] name");
            if (this->sorting==1)
