...
char *CDisplayHandler::GetFilelistString(FILELIST * filelist, int magic,
    ...
    if (fl_temp) {
        *is_marked = fl_temp->is_marked;
        ...
        strncpy(temp_name, fl_temp->name,PATHLEN);
...
void
CDisplayHandler::UpdateServerFilelist(CServer * server, WINDOW * window) {
