...
*/
		...
		this->use_pasv = TRUE;
		this->use_ssl = this->use_ssl_list = this->use_ssl_data = TRUE;
                this->OpenPrefsDialog();
                break;
    ...
    case DISPLAY_STATE_PREFS:
        ...
        case MSG_KEY_RIGHT:
            ...
            if (this->prefsdialog_buttonstate > 26)
        ...
        case MSG_KEY_LEFT:
            ...
            if (this->prefsdialog_buttonstate < 0)
                this->prefsdialog_buttonstate = 26;
        ...
        case MSG_KEY_RETURN:
            ...
            case 1:
                this->internal_state = DISPLAY_STATE_PREFSINPUT;
                this->prefs_inputtype = -1;
                this->DialogInput("enter site hostname or IP",
            ...
            case 4:
                ...
                this->DialogInput("enter site port (decimal)",
                                  this->num_string, 6, FALSE);
                break;
...
void CDisplayHandler::sigwinch(int sig)
{
    int cols1, lines1;
    struct winsize size;
    debuglog("sigwinch sig : '%d' need resize : '%d'", sig,
             need_resize);
